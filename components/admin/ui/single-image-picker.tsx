      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 space-y-2 min-w-0">
          ...
          <input
            ...
            placeholder="/uploads/education/logo.png or https://..."
            className="w-full px-3 py-2 rounded-lg bg-bg-tertiary border border-border focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent-soft transition-all text-xs"
          />
